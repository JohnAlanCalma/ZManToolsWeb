...
$(document).ready(function () {
  ...
  jQuery.ajax({
      url: 'https://zmantools.azurewebsites.net/api/forge/oauth/token',
    success: function (res) {
      ...
      $('#signOut').click(function () {
        $('#hiddenFrame').on('load', function (event) {
            location.href = 'https://zmantools.azurewebsites.net/api/forge/oauth/signout';
        });
  ...
  $('#autodeskSigninButton').click(function () {
    jQuery.ajax({
        url: 'https://zmantools.azurewebsites.net/api/forge/oauth/url',
    ...
    $.getJSON("https://zmantools.azurewebsites.net/api/forge/clientid", function (res) {
    $("#ClientID").val(res.id);
...
function prepareUserHubsTree() {
  ...
  $('#userHubs').jstree({
    'core': {
      ...
      'multiple': false,
      'data': {
          "url": 'https://zmantools.azurewebsites.net/api/forge/datamanagement',
        "dataType": "json",
        'cache': false,
        'data': function (node) {
    ...
    'types': {
      ...
      'hubs': {
          'icon': 'https://zmantools.azurewebsites.net/www/img/a360hub.png'
      },
      'personalHub': {
          'icon': 'https://zmantools.azurewebsites.net/www/img/a360hub.png'
      },
      'bim360Hubs': {
          'icon': 'https://zmantools.azurewebsites.net/www/img/bim360hub.png'
      },
      'bim360projects': {
          'icon': 'https://zmantools.azurewebsites.net/www/img/bim360project.png'
      },
      'a360projects': {
          'icon': 'https://zmantools.azurewebsites.net/www/img/a360project.png'
      },
      'items': {
...
function showUser() {
  jQuery.ajax({
      url: 'https://zmantools.azurewebsites.net/api/forge/user/profile',
